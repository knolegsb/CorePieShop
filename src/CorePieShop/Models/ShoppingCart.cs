...
namespace CorePieShop.Models
{
    public class ShoppingCart
    {
        ...
        public static ShoppingCart GetCart(IServiceProvider services)
        {
            ...
            return new Models.ShoppingCart(context) { ShoppingCartId = cartId };
        }
        ...
        {
            return ShoppingCartItems ?? (ShoppingCartItems = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId).Include(s => s.Pie).ToList());
        }
